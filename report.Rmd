...
\end{equation}
where $x_1^\downarrow \ge x_2^\downarrow \ge \ldots \ge x_n^\downarrow$ is the ordered permutation of the vector $(\vert x_1\vert,\vert x_2\vert,\ldots,\vert x_n\vert)$ and $\theta\in\R_+^n$ is a hyperparameter of the model.
...
We are interested in the algorithmic properties of the problem $\eqref{eq:SLOPE}$.
